...
% 		exemples d’architecture de réseau virtuel
      ...
      Si l'on prend cette fois-ci l'exemple d'une architecture formée par un ensemble d'objets utilisant 
...
% 		exemple concret d’un envoi de message
		...
		\subsubsection{Le protocole VIP}
			...
			Maintenant, on va analyser l'envoi d'un message vers une destination plus lointaine.
			...
			Comme l'ont montré ces exemples, l'utilisation des tables de routage est un bon moyen pour
...
construire
		...
		Finalement, l'arbre des types d'actions a été écrit manuellement en essayant de faire le tour
