...
s'appelle AllJoyn qui seront expliqués après. Ces protocoles n'ont pas été utilisés, car ils ne possédaient 
pas l'ensemble des caractéristiques qui seront décrites plus tard. 
...
communication, et en étant compatible avec tous les systèmes du marchés. Depuis, ce protocole est porté par 
de nombreuses sociétés telles que Microsoft, LG, Sony, Cisco, etc.
